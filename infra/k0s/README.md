...
Per node VM: kernel and modules required by your Cilium version, sysctl/conntrack tuning as documented by Cilium, correct MTU if using encapsulation, and **no leftover CNI** from other installers.
