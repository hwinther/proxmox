...
| **Prod cluster, `test` NS** | Same `*.test.wsh.no` pattern | `test.test.wsh.no` — sample `ghcr.io/hwinther/test` app ([`clusters/production/apps/test/`](../../../clusters/production/apps/test/README.md)) |
